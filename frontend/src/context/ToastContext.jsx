      ...
      {createPortal(
        ...
        >
          {toasts.map((toast) => (
            <div
              key={toast.id}
              className={`pointer-events-auto flex items-start gap-3 p-3.5 rounded-xl shadow-card border backdrop-blur-md text-sm transition-all duration-200 animate-fade-in ${
                toast.type === 'success'
